    ...
    <div className="analytics">
      {chart_i && (
        <>
          ...
          <BarChart className="chart" width={250} height={210} data={data}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="Followers" fill="#333131" />
            <Bar dataKey="Earnings" fill="#7e0606" />
          </BarChart>
        </>
      )}
      ...
      {chart_ii && (
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="pv" stroke="#333131" />
          <Line type="monotone" dataKey="uv" stroke="#7e0606" />
        </LineChart>
      )}
